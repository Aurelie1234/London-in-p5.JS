...
function redCar(x, y, size1){

//red car 
fill("#ff3300");
rect(x+13, y+10, size1-16, size1/4);
fill("black");
circle(x + 24, y + 32, size1 / 5);
circle(x + 62, y + 32, size1 / 5);
fill("#ff3300");
rect(x+29, y-6, size1 /2.5, size1 /4.5);

}


function blueCar(x, y, size1){

//blue car 
fill("#002266");
rect(x+13, y+66, size1 -16, size1 /4);
fill("black");
circle(x + 24, y + 88, size1 / 5);
circle(x + 62, y + 88, size1 / 5);
fill("#002266");
rect(x+29, y + 50, size1 /2.5, size1 /4.5);
